...
export default class ToDoItem extends ViewPU {
    ...
    labelIcon(icon, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.width({ "id": 16777221, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            Image.height({ "id": 16777221, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            Image.margin({ "id": 16777220, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            if (!isInitialRender) {
                Image.pop();
            }
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.height({ "id": 16777223, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            Row.onClick(() => {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.fontSize({ "id": 16777222, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
