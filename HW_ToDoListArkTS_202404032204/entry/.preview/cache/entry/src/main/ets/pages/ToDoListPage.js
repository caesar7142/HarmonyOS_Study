...
class ToDoListPage extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create({ "id": 16777231, "type": 10003, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            Text.debugLine("pages/ToDoListPage.ets(31:7)");
            Text.fontSize({ "id": 16777225, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            Text.fontWeight(FontWeight.Bold);
            Text.lineHeight({ "id": 16777224, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            Text.width(CommonConstants.TITLE_WIDTH);
            Text.margin({
                top: { "id": 16777227, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" },
                bottom: { "id": 16777226, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" }
            });
