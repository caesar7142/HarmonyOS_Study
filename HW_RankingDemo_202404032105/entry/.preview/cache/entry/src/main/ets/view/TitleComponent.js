...
export class TitleComponent extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.debugLine("view/TitleComponent.ets(25:5)");
            Row.width(WEIGHT);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("view/TitleComponent.ets(26:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create({ "id": 16777220, "type": 20000, params: [], "bundleName": "com.example.rankdemo", "moduleName": "entry" });
            Image.debugLine("view/TitleComponent.ets(27:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/TitleComponent.ets(35:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("view/TitleComponent.ets(42:7)");
            Row.width(TitleBarStyle.WEIGHT);
            Row.height(WEIGHT);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("view/TitleComponent.ets(43:9)");
